...
<body class="bg-gradient-primary">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome Back Pokemon Bank</h1>
                                    </div>
    ...
    $("#login").submit(async function(event) {
        ...
        console.log(datos);
        if(datos.allowed === "true"){
          localStorage.setItem("log", "user");
           return window.location.href = 'pokebank.php'
        }else{
         return  Swal.fire({
            icon: "error",
            title: "User / pass wrong",
            text: "Por favor contactar con el administrador",
        });
        }
